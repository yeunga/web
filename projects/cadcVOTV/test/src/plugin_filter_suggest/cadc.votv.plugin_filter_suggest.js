...
test("Suggest items for 73.", 1, function ()
{
  ...
  viewer.getDataView().onRowsChanged.subscribe(function (event, args)
                                               {
                                                 rowsChangedCount++;

                                                 if (rowsChangedCount == 1)
                                                 {
                                                   var found = args.rows.length;
                                                   equal(found, 3, "Should have three items but found " + found);
                                                 }
                                               });
