test("Read in simple CSV VOTable.", 24, function ()
{
  ...
  try
  {
    ...
    var input = {tableMetadata: tm,
      csv: "csvData"};
    var eventCounter = 0;

    var genericBuilder = new cadc.vot.Builder(input);
    var voTableBuilder = new cadc.vot.CSVBuilder(input,
                                                 genericBuilder.buildRowData);
    ...
    equal(eventCounter, 7, "eventHandler should have been called seven times by now.");
